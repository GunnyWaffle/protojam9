...
public class MenuHandler : MonoBehaviour
{
    ...
    private bool allowPlayerControl = false;
    ...
    private void HandleInput()
    {
        ...
        if (Mathf.Abs(movement) > deadzoneTolerance && !waitForDeadzone)
        {
            ...
            if (selectedIndex < 0)
            { //Cmon now unity... Mod not wrapping negatives around???
    ...
    public void SetPlayerControlAbility(bool set)
    {
        allowPlayerControl = set;
    }
}
